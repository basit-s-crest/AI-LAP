...
function generateMockAnalysis(transcript, memberName) {
...
async function runAnthropicAnalysis(formattedTranscript, apiKey) {
...
const createAiSessionNote = async (req, res) => {
    try {
        ...
        const { memberId, sessionId, transcript } = req.body;
